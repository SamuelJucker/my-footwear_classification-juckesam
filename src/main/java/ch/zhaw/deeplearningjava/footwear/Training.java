...
public final class Training {
    ...
    public static void main(String[] args) throws IOException, TranslateException {
        ...
        ImageFolder dataset = initDataset("st-stanford-car/train2");
    ...
    private static ImageFolder initDataset(String datasetRoot) throws IOException, TranslateException {
        ImageFolder dataset = ImageFolder.builder()
                ...
                // .addTransform(new Normalize(new float[]{0.485f, 0.456f, 0.406f}, new float[]{0.229f, 0.224f, 0.225f}))  // Example normalization
...
//         ImageFolder dataset = initDataset("st-stanford-car/test");
